  ...
  },
  {
    capabilities: {
      tools: {
        ...
        "spiderfoot_scan": {
          description: "Comprehensive OSINT scan - auto-detects target type (IP, domain, email, phone, username, etc.)"
        },
        "ghunt_google_search": {
          description: "Search for Google account information using email address or Google ID"
        },
        "maigret_username_search": {
          description: "Search for username across 3000+ sites with detailed analysis"
        },
        "theharvester_domain_search": {
